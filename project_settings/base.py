...
INSTALLED_APPS = [
    ...
    'django.contrib.sites',  # Required for admin_charts
...
WSGI_APPLICATION = 'EcoPath.wsgi.application'
...
# Admin Charts
ADMIN_CHARTS_CONFIG = 'mainapp.admin_charts.py'
